				...
				<form id="fdCheckoutForm_<?php echo $index;?>" action="" method="post" class="fdForm">
					...
					if($tpl['option_arr']['o_payment_disable'] == 'No')
					{
						...
						<p class="fdParagraph">
							...
							<select id="fdPaymentMethod_<?php echo $index;?>" name="payment_method" class="fdSelect fdW50p required" data-err="<?php __('front_payment_method_required');?>">
								<option value="">----</option>
								<?php
					...
					<div id="fdCCData_<?php echo $index;?>" style="display: <?php echo isset($FORM['payment_method']) && $FORM['payment_method'] == 'creditcard' ? 'block' : 'none'; ?>">
						<p class="fdParagraph">
							<label class="fdTitle"><?php __('front_cc_type'); ?>&nbsp;<span class="fdRed">*</span>:</label>
							<select name="cc_type" class="fdSelect fdW50p required" data-err="<?php __('front_cc_type_required');?>">
								<option value="">----</option>
								<?php
						...
						<p class="fdParagraph">
							<label class="fdTitle"><?php __('front_cc_number'); ?>&nbsp;<span class="fdRed">*</span>:</label>
							<input type="text" name="cc_num" class="fdText fdW50p required" value="<?php echo htmlspecialchars(stripslashes(@$FORM['cc_num'])); ?>" data-err="<?php __('front_cc_num_required');?>"/>
						</p>
						<p class="fdParagraph">
							<label class="fdTitle"><?php __('front_cc_exp'); ?>&nbsp;<span class="fdRed">*</span>:</label>
							<span class="fdBlock fdOverflow">
								<select name="cc_exp_month" class="fdSelect fdW120 fdR5 required" data-err="<?php __('front_cc_exp_month_required');?>">
									<option value="">----</option>
									<?php
								...
								<select name="cc_exp_year" class="fdSelect fdW120 required" data-err="<?php __('front_cc_exp_year_required');?>">
									<option value="">----</option>
									<?php
									$y = (int) date('Y');
									for ($i = $y; $i <= $y + 10; $i++)
						...
						<p class="fdParagraph">
							<label class="fdTitle"><?php __('front_cc_code'); ?>&nbsp;<span class="fdRed">*</span>:</label>
							<input type="text" name="cc_code" class="fdText fdW50p required" value="<?php echo htmlspecialchars(stripslashes(@$FORM['cc_code'])); ?>" data-err="<?php __('front_cc_code_required');?>"/>
						</p>
					</div>
					<div class="fdCrossLine"></div> 
					<?php

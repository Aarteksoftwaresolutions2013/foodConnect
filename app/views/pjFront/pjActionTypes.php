			...
			{ 
				...
				<form id="fdTypeForm_<?php echo $index; ?>" action="" method="post" class="fdMainWidth">
					...
					<div class="fdTypeHeading">
						...
						<label for="fdTypeDelivery_<?php echo $index; ?>" class="fdType fdTypeDelivery<?php echo $isDelivery ? ' fdTypeFocus' : NULL; ?>">
							<abbr class="left"></abbr> 
							<abbr class="middle"><?php echo strtoupper(__('front_delivery')); ?></abbr>
							<abbr class="right"></abbr>
						</label>
